//Nodemcu agin_adi ile var olan bir aga baglaniyor. Bu ag ile erişebilecegi bir web sunucusuna 
// baglanip oradan web sayfasını http protokolü ile istiyor.
#include <ESP8266WiFi.h>

const char *agin_adi = "xxxxxxxxxxx";				// baglanilan wifi aginin adi
const char *sifre = "xxxxxxxx";     				// baglanilan wifi aginin sifresi,min 8 karakter

const char* web_adresi = "xxxxxxxxxxxxxxxxxx";		// baglanilacak web sunucu adresi veya IP adresi
const uint16_t port = 80;							// baglanilacak sunucu portu

String uzanti="xxxxxxxxxxxxxxx";					// baglanilacak olan web sayfasinin uzantisi biz burada anasayfa için / koyuyoruz
//****************************************************************
void setup() 
{
